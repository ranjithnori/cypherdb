<%-- 
    Document   : file_down
    Created on : Sep 16, 2016, 6:31:37 PM
    Author     : java4
--%>
                        ...
                        <BR><h1><font style="color: #00060C">CypherDB: A Novel Architecture for Outsourcing Secure Database Processing</font></h1>
                                                            ...
                                                            <div id="main">
                                                                <div id="right">
                                                                    ...
                                                                    <!--==============================body start=================================-->
                                                                    <br><br><center><h2 style="font-size: 26px; color: #00AEFF; font-family: cursive">Download file Details</h2>
                                                                                <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                                                                                        <tr>
                                                                                            <th style="text-align: center;width: 200px; font-size: 16px; color: brown">S.No</th>
                                                                                            <th style="text-align: center;width: 200px; font-size: 16px; color: brown">Customer Name</th>
                                                                                            <th style="text-align: center;width: 400px;  font-size: 16px; color: brown">File Name</th>
