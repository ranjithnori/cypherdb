<%-- 
    Document   : reg
    Created on : Sep 13, 2016, 5:38:35 PM
    Author     : java4
--%>
                        ...
                        <BR><h1><font style="color: #00060C">CypherDB: A Novel Architecture for Outsourcing Secure Database Processing</font></h1>
                                                            ...
                                                            <div id="main">
                                                                <div id="right">
                                                                    ...
                                                                    <!--==============================body start=================================-->
                                                                    <br><br><center><h2 style="font-size: 26px; color: #2198EA; font-family: cursive">Registration</h2>
                                                                                <br><form action="login.jsp" method="get"> 
                                                                                        ...
                                                                                        <input type="password" class="inputs" name="pass" required="" placeholder="Password" /><br> 
                                                                                            ...
                                                                                            <input type="date" class="inputs" name="dob" required="" placeholder="Date Of Birth" /><br> 
                                                                                                ...
                                                                                                <input type="text" class="inputs" name="phone" required="" placeholder="Mobile Number" /><br> 
