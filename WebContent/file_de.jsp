<%-- 
    Document   : file_de
    Created on : Sep 16, 2016, 3:11:16 PM
    Author     : java4
--%>
                                                                    ...
                                                                    <br><br><center><h2 style="font-size: 26px; color: #00AEFF; font-family: cursive">Uploaded file Details</h2>
                                                                                <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                                                                                        <tr>
                                                                                            ...
                                                                                            <th style="text-align: center;width: 200px;  font-size: 16px; color: brown">Random Kay</th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <%
                                                                                            ...
                                                                                            <td style="font-size: 16px"><br><%=rs.getString("random")%></td>   
                                                                                        </tr>
                                                                                        <%
                                                                                                }
                                                                                            } catch (Exception ex) {
